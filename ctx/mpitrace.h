...
static struct eventstruct * event;
...
static long long event_count[MAX_CONTEXTS][MAX_IDS];
static double total_time[MAX_CONTEXTS][MAX_IDS];
static double total_bytes[MAX_CONTEXTS][MAX_IDS];

static char label[MAX_IDS][80];
static char context_label[MAX_CONTEXTS][80];

static long long bin_count[MAX_CONTEXTS][MAX_IDS][MAX_BINS];
static double bin_bytes[MAX_CONTEXTS][MAX_IDS][MAX_BINS];
static double bin_time[MAX_CONTEXTS][MAX_IDS][MAX_BINS];

static double total_size[MAX_CONTEXTS][MAX_BINS];
static int comm_size[MAX_CONTEXTS][MAX_BINS];
static long long comm_count[MAX_CONTEXTS][MAX_IDS][MAX_BINS];
static double comm_bytes[MAX_CONTEXTS][MAX_IDS][MAX_BINS];
static double comm_time[MAX_CONTEXTS][MAX_IDS][MAX_BINS];
...
static double synctime[MAX_CONTEXTS];
...
static int ctx = 0;    // context index
static int maxctx = 0;
static double context_tbeg[MAX_CONTEXTS];
static double context_elapsed[MAX_CONTEXTS];
static long context_starts[MAX_CONTEXTS];
static long context_stops[MAX_CONTEXTS];
...
void mpitrace_Context_start(const char *);
void mpitrace_Context_stop(const char *);
void mpitrace_context_start(const char *, int);
void mpitrace_context_stop(const char *, int);
