...
// group 5:
  {
    "skx_unc_imc0::UNC_M_CAS_COUNT:RD:cpu=1", "reads from imc0 cpu=0",
    "skx_unc_imc1::UNC_M_CAS_COUNT:WR:cpu=1", "writes  to imc1 cpu=0",
    "skx_unc_imc2::UNC_M_CAS_COUNT:RD:cpu=1", "reads from imc2 cpu=0",
    "skx_unc_imc3::UNC_M_CAS_COUNT:WR:cpu=1", "writes  to imc3 cpu=0",
    "skx_unc_imc4::UNC_M_CAS_COUNT:RD:cpu=1", "reads from imc4 cpu=0",
    "skx_unc_imc5::UNC_M_CAS_COUNT:WR:cpu=1", "writes  to imc5 cpu=0"
  }
};
